      ...
      <div class="relative" id="home">
        ...
        <div class="relative pt-36 ml-auto">
          <div class="lg:w-2/3 text-center mx-auto">
            <h1 class="text-gray-900 dark:text-white font-bold text-3xl md:text-4xl xl:text-6xl">
              Tu Solución de Confianza para el Cuidado de los que más
              <span class="text-primary dark:text-white"> amas.</span>
            </h1>
            ...
            <div class="hidden py-8 mt-16 border-y border-gray-100 dark:border-gray-800 sm:flex justify-between gap-10">
