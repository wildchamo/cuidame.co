        ...
        <div className="relative z-10 bg-white p-6 rounded-lg shadow-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <input
                {...register("availableHours", { required: "Los horarios disponibles son requeridos" })}
                type="text"
                placeholder="Ingrese sus horarios disponibles (ej. 9am - 5pm)"
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              />
              {errors.availableHours && <p className="text-red-500 text-sm mt-1 ml-1">{errors.availableHours.message}</p>}
            </div>

            <div>
              <label className="block text-gray-700">Experiencia</label>
              <textarea
                {...register("experience", { required: "La experiencia es requerida" })}
                placeholder="Describa brevemente su experiencia en el cuidado"
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ></textarea>
              {errors.experience && <p className="text-red-500 text-sm mt-1 ml-1">{errors.experience.message}</p>}
            </div>
